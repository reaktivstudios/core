    ...
    public function render_panel() {
        ...
        <div id="rkv-admin-notices-panel">
            ...
            <div class="rkv-admin-notices-panel-none empty-notices-message" style="display: none;">
                ...
                <p><?php esc_html_e( 'There are currently no admin notices.', 'rkv-utilities' ); ?>
                <?php $show_notice_settings = apply_filters( 'rkv_show_admin_notice_settings', true ); ?>
                <?php if ( $show_notice_settings ) : ?>
                    <a target="_blank" href="<?php echo esc_url( admin_url( 'options-general.php?page=admin-notice-settings' ) ); ?>"><?php esc_html_e( 'Edit the settings.', 'rkv-utilities' ); ?></a>
                <?php endif; ?>
                </p>
            </div>
